...
class UserService {
  ...
  static Future<User> updateUser(
      String idsv, String cccd, String phone, String address, String department, String className) async {
    final res = await UserService().appService.network.patch(
        '/users/update/$idsv',
        data: {'cccd': cccd, 'phone': phone, 'address': address, 'department': department, 'className': className });
