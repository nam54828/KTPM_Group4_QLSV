...
class InfoEdutForm extends StatelessWidget {
  ...
  final _cccd = RegExp('[0-9]*');
  final _sdt = RegExp('[0-9]*');
              ...
              children: [
                ...
                _EditField(
                    ...
                    child: TextField(
                        ...
                        inputFormatters: [
                          FilteringTextInputFormatter.allow(_sdt),
                ...
                _EditField(
                    ...
                    child: TextField(
                      keyboardType: TextInputType.number,
                        ...
                        inputFormatters: [
                          FilteringTextInputFormatter.allow(_cccd),
                ...
                _EditField(
                    ...
                    child: TextField(
                        keyboardType: TextInputType.number,
                        controller: TextEditingController()
                          ..text = c.user.value.className.name,
                        cursorColor: kPrimaryColor,
                        onChanged: (String text) => c.user.value.className.name = text,
                        style: TextStyle(
                          // fontWeight: FontWeight.w500
                            color: Colors.black.withOpacity(0.8)),
                        decoration: kPrimaryInput.copyWith(
